...
const copy={
  ...
  primary:['View portfolio','查看个人资料'],explore:['Explore the academy','探索学院'],papers:['Publications','学术论文'],projects:['Projects','研究作品'],cv:['Download CV','下载简历'],
  ...
  detailLoading:['Scene details are loading…','场景细节加载中…'],detailReady:['Full scene detail ready','完整场景细节已就绪'],detailDegraded:['Some details could not load. Exploration and reading remain available.','部分细节未能加载，仍可探索和阅读。'],
...
export class Interface {
  ...
  update(s){
    ...
    this.root.querySelector('.interaction-prompt strong').textContent=!exhibit&&s.nearestClock?(this.t('clockJump')):this.t('interact');
