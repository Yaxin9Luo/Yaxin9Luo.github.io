...
export class Interface {
  ...
  applyLanguage(){
    ...
    this.root.querySelectorAll('.persistent-cv,.modal-cv').forEach(link=>link.setAttribute('aria-label',`${t('cv')} · PDF`));
