...
function palette(){
  ...
  const result={
    ...
    paving:pbr('Garden honed paving','courtyard-paving','#e4e5dc',{metres:2,normal:.45,albedoStrength:1,roughness:.87,roughnessFloor:.60}),
    pavingLight:pbr('Garden pale paving','courtyard-paving','#ecece2',{metres:2,normal:.40,albedoStrength:1,roughness:.82,roughnessFloor:.60}),
