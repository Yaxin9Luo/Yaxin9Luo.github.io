...
export async function loadBuildingDistanceArchive({manifestURL,expectedManifestSHA256,expectedReportSHA256,approvedDistanceSHA256}={}, {signal,fetchImpl=globalThis.fetch,onProgress,yieldControl}={}){
