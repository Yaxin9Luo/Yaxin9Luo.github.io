...
export const tourStops=[
  {id:'about',position:[54,52,62],title:{en:'Hello, I’m Yaxin.',zh:'你好，我是 Yaxin。'},description:{en:'A PhD student at MBZUAI. I build native multimodal systems for agentic design and self-improving long-horizon harnesses.',zh:'我在 MBZUAI 攻读博士，研究原生多模态系统、多模态智能体设计与长程 Harness 自迭代。'}},
  ...
  {id:'projects',position:[88,26,78],title:{en:'Things I’m building.',zh:'我在做的项目。'},description:{en:'AutoDesign explores how an agent can improve its own design harness through rollout feedback. FigMirror turns data and visual references into editable scientific figures.',zh:'AutoDesign 探索智能体如何依据 rollout 反馈改进自己的设计 Harness。FigMirror 将数据和视觉参考转化为可编辑科研图表。'}},
