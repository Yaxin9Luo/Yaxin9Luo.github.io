...
const release={version:'2026.09.14.3',commit:process.env.GITHUB_SHA??process.env.SITE_REVISION??null,assetRevision:manifest.revision,builtAt:new Date().toISOString(),externalAssets:Object.keys(manifest.files).length,originalAssetBytes:originalBytes,museumStatus:'Work in progress; Western Buildings route and Jiuzhou study available'};
